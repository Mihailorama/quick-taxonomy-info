...
storiesOf('AppBar', module)
  ...
  .add('Loading', () => <AppBar path='/quick-taxonomy-info/'/>)
  .add('User with email only', () => <AppBar path='/quick-taxonomy-info/'
    apps={apps('Quick Taxonomy Info')}
    user={{sub, email: 'b@example.com'}}/>)
  .add('User with name', () => <AppBar path='/quick-taxonomy-info/'
    apps={apps('Quick Taxonomy Info')}
    user={{sub, name: 'Tamandani Pleško', email: 'tp@example.com'}}/>)
  .add('Multiple apps', () => <AppBar path='/quick-taxonomy-info/'
    apps={apps('Quick Taxonomy Info', 'Beacon', 'Full Beam', 'Manage Account')}
