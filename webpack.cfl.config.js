...
const mergedConfig = merge.smart(mainConfig, {
  output: {
    publicPath: `${baseUrl}/quick-taxonomy-info/`,
  },
  ...
  devServer: {
    ...
    setup: function (app) {
      ...
      app.get('/api/apps', (req, res) => {
        res.json([
          {"id":"quick-taxonomy-info","name":"Quick Taxonomy Info","href":"/quick-taxonomy-info/","colour":"#69BEAB","iconHref":"/img/logo-beacon.svg","features":[]},
      ...
      app.get('/', (req, res) => {
        res.redirect('/quick-taxonomy-info/');
      });
    },
